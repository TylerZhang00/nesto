...
const FixedRateContainer = ({ applied, complete, editing, product }) => {
  // Hooks
  ...
  return (
    <>
      <S.IndividualMortgageContainer editing={editing} fixed="true">
        <S.TextContainer>
          <S.TitleContainer>
            Lowest Fixed Rate{" "}
            <Tooltip
              placement="top"
              title="A fixed-rate mortgage is a mortgage loan where the interest rate on the note remains the same through the term of the loan."
            >
              <S.IconContainer>
                <QuestionCircleOutlined
...
export default FixedRateContainer;
